...
(library Library_1
	...
	(patternDef "CAPPRD200W50D525H1100" (originalName "CAPPRD200W50D525H1100")
		...
		(layerContents (layerNumRef 28)
			(arc (pt 1, 0) (radius 2.625) (startAngle 0.0) (sweepAngle 0.0) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(arc (pt 1, 0) (radius 2.625) (startAngle 180.0) (sweepAngle 180.0) (width 0.025))
		)
	)
	...
	(compDef "SEK100M050ST" (originalName "SEK100M050ST") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		...
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/2/SEK100M050ST.pdf")
		(attr "<Component Height>" "11")
		(attr "<STEP Filename>" "SEK100M050ST.stp")
