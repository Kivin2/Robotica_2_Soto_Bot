...
(library Library_1
	...
	(patternDef "DIOAD1405W58L465D235" (originalName "DIOAD1405W58L465D235")
		...
		(layerContents (layerNumRef 28)
			(line (pt 4.725 1.175) (pt 9.375 1.175) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 9.375 1.175) (pt 9.375 -1.175) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 9.375 -1.175) (pt 4.725 -1.175) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 4.725 -1.175) (pt 4.725 1.175) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 4.725 0) (pt 5.9 1.175) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 0 0) (pt 4.725 0) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 9.375 0) (pt 14.1 0) (width 0.1))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "1N4007" (originalName "1N4007") (compHeader (numPins 2) (numParts 1) (refDesPrefix D)
		...
		(attr "Datasheet Link" "https://diotec.com/tl_files/diotec/files/pdf/datasheets/1n4001.pdf")
	)
