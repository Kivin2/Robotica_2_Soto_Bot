...
class MPU6050:
    ...
    def test_connection(self):
        return self.i2c.readfrom_mem(self.address, 0x75, 1)[0] == 0x68
    ...
    def get_acceleration(self):
        ...
        ay = (data[2] << 8) | data[3]
        az = (data[4] << 8) | data[5]
        ax = ax if ax < 32768 else ax - 65536  # Convertir a valor con signo
        ay = ay if ay < 32768 else ay - 65536
        az = az if az < 32768 else az - 65536
        return ax, ay, az
